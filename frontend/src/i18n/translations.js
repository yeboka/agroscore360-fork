...
export const translations = {
  en: {
    ...
    shapExplain:
      "SHAP values show how each feature pushed the score above or below the average baseline.",
    ...
    // Footer
    footerNote:
      "AgroScore 360 — GovTech Hackathon MVP. All data is anonymized.",
  },
  ...
  kk: {
    ...
    shapExplain:
      "SHAP мәндері әрбір ерекшеліктің орташа базалық деңгейден жоғары немесе төмен балға қалай әсер еткенін көрсетеді.",
    ...
    footerNote:
      "AgroScore 360 — GovTech хакатон MVP. Барлық деректер жасырынды.",
  },
  ...
  ru: {
    ...
    shapExplain:
      "Значения SHAP показывают, как каждый признак сдвигает балл выше или ниже среднего базового значения.",
    ...
    footerNote:
      "AgroScore 360 — GovTech Хакатон MVP. Все данные анонимизированы.",
  },
};
